...
pyinstaller dndkit.spec
```

## Built with

Python + Flet. All data is JSON, loaded at startup. No network calls.

## License

MIT — do whatever you want with it.

Dungeons & Dragons is a trademark of Wizards of the Coast. This is unofficial and not affiliated with WotC.
